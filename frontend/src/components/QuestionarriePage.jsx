  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow flex items-center justify-center bg-gray-100">
        <div className="bg-white bg-opacity-90 p-8 rounded shadow-lg max-w-2xl w-full my-8">
          <h2 className="text-2xl font-bold mb-4">Questionnaire</h2>
          <form id="questionnaire-form" onSubmit={handleSubmit} className="space-y-4 max-h-[60vh] overflow-y-auto pr-4">
          ...
          <button type="submit" form="questionnaire-form" className="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mt-4">
            Submit
          </button>
        </div>
      </main>
